...
## Analysis Performed
- Histogram with KDE to inspect distribution shape
- Boxplot to detect outliers and analyze spread
- Group comparison of total bills across different days

## Outputs
The following plots were generated and saved:
- histogram_total_bill.png
- boxplot_total_bill.png
- comparison_by_day.png
